...
const LoginRegister: FC = () => {
    return (
        <div className="w-full bg-gray-200 min-h-screen flex justify-center items-center">
            <div className="flex w-2/3 shadow-2xl">
                ...
                <div className="bg-gray-100 rounded-e-xl animation-container overflow-hidden p-8 space-y-8 flex-1">
                    ...
                    <p className="text-center text-purple-500 animation-p text-gray-200">
                        Crie a sua conta
                    </p>
                    <form method="POST" action="#" className="space-y-6">
                     <div className="relative">
                            <input
                                placeholder="Aninha"
                                className="peer h-10 w-full border-b-2 border-gray-300 text-white bg-transparent placeholder-transparent focus:outline-none focus:border-purple-500 text-gray-400"
                                required
                                id="name"
                                name="name"
                                type="name"
